...
RSpec.describe CandidateInterface::TaskListItemComponent do
  def render_component(completed:)
    render_inline(described_class.new(text: 'Personal details', path: '/personal-details', completed: completed))
  end
